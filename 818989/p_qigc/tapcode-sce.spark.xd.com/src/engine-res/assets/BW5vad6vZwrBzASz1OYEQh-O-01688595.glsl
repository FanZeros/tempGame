...
void PS()
{
    ...
    // Deferred
        ...
        #else
            EncodeGBufferPBR(surfaceAlbedo, surfaceMetallic, surfaceSpecular, surfaceRoughness, surfaceNormal, surfaceEmission, SHADINGMODELID_PBR_LIT);
        #endif
    #else
        #ifdef SURFACE_GENERIC_OUTLINE
        ...
        #else
        // PBR calc
        vec3 finalColor = MetallicPBR(surfaceAlbedo, surfaceMetallic, surfaceSpecular, surfaceRoughness, surfacePosition, surfaceNormal, surfaceViewDir, shadowColor.rgb, surfaceOcclusion
        #ifdef USES_ANISOTROPY
            ,  cAnisotropy
        #endif
        #ifdef CLEAR_COAT
            , surfaceClearCoat, surfaceClearCoatRoughness
        #endif
            );
