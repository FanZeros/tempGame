...
uniform hfloat u_FarClipDepth; //float
...
#define cCameraPositionWorld cCameraPos
#define cNearClip u_NearClip
#define cFarClip u_FarClip
#define cFarClipDepth u_FarClipDepth
...
uniform vec3 u_LightTangent;
uniform vec4 u_LightRectParams; // (halfWidth, halfHeight, barnCosAngle, barnLength)
...
#define cCameraPositionWorld cCameraPosPS
#define cDeltaTime u_DeltaTimePS
#define cDeltaTimePS u_DeltaTimePS
#define cDepthReconstruct u_DepthReconstruct
#define cElapsedTime u_ElapsedTimePS
...
#define cLightPos u_LightPosPS
#define cLightPosPS u_LightPosPS
#define cLightDir u_LightDirPS
...
#define cLightTangent u_LightTangent
#define cLightRectParams u_LightRectParams
#define cNormalOffsetScale u_NormalOffsetScalePS
...
#define cNearClip u_NearClipPS
#define cNearClipPS u_NearClipPS
#define cFarClip u_FarClipPS
...
#define cLightMatrices u_LightMatricesPS
