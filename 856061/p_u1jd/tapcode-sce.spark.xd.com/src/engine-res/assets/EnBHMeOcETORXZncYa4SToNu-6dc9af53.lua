-- ============================================================================
-- UrhoX UI Gallery — Default TapTap Style
-- Elegant showcase of all 42 UI widgets with interactive demos
-- Styled with TapTap theme: mint green, teal primary, clean flat rounded style
-- ============================================================================
...
function Start()
    ...
    local root = UI.Panel {
        ...
        width = "100%",
        height = "100%",
        backgroundColor = { 246, 246, 246, 255 },
    }
