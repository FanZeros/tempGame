...
---@field isOpen? boolean Is modal visible
---@field title? string Modal title
---@field size? string "sm" | "md" | "lg" | "xl" | "fullscreen" (default: "md")
---@field closeOnOverlay? boolean Close when clicking overlay (default: true)
---@field closeOnEscape? boolean Close on Escape key (default: true)
---@field showCloseButton? boolean Show close button (default: true)
---@field contentPadding? number|table Content area padding: number for uniform, or {top, right, bottom, left} (default: 16)
---@field contentGap? number Gap between content children (default: 8)
---@field footerPadding? number|table Footer padding: number for uniform, or {top, right, bottom, left} (default: {12, 16, 12, 16})
---@field headerBorderRadius? number|table Header background radius
...
---@field backgroundColor? RGBAColor|string Dialog panel background color
---@field headerStripeColor? RGBAColor|string Header bottom stripe color
---@field headerStripeHeight? number Header bottom stripe height
---@field titleTextColor? RGBAColor|string Title text color
---@field closeIconColor? RGBAColor|string Close icon color
---@field titleFontWeight? string Title font weight
---@field titleFontSize? number Title font size in pt (default: Theme.FontSizeOf("subtitle"))
---@field contentFontSize? number Body font size in pt, applied as a fontSize override to Label content added via AddContent; the Label's own explicit fontSize is not restored (default: none = each Label keeps its own size)
---@field onClose? fun(self: Modal) Close callback
---@field onOpen? fun(self: Modal) Open callback
