...
--- Pipeline step: resolve language, set variant tag, prefetch engine + project translation files.
        ...
        onExecute = function(step)
            ...
            dm:DownloadResource("i18n.json", function(task)
                ...
                if sourceLang and sourceLang ~= ""
                    ...
                    local sourceEngineUri = engineLangUri(sourceLang)
                    if sourceEngineUri then uris[#uris + 1] = sourceEngineUri end
                    uris[#uris + 1] = "i18n/" .. sourceLang .. ".json"
                end
