-- ============================================================================
-- UrhoX UI Gallery — Golden Bazaar Edition
-- Warm parchment merchant theme: rounded stone corners, golden accents
-- ============================================================================
...
local BAZAAR_SHADOW = {
    { x = 4, y = 4, blur = 1, color = {110, 93, 70, 40} },
    { x = -1, y = -1, blur = 0, color = {255, 244, 216, 255} },
}

local GoldenBazaarTheme = UI.Theme.ExtendTheme(UI.Theme.defaultTheme, {
    colors = {
        primary = {216, 164, 65, 255},
        primaryHover = {228, 189, 105, 255},
        primaryPressed = {191, 141, 43, 255},
        secondary = {184, 170, 149, 255},
        secondaryHover = {200, 185, 165, 255},
        secondaryPressed = {165, 148, 125, 255},
        background = {243, 233, 215, 255},
        surface = {205, 191, 170, 255},
        surfaceHover = {217, 204, 185, 255},
        text = {79, 67, 52, 255},
        textSecondary = {126, 113, 99, 255},
        textDisabled = {155, 142, 126, 255},
        border = {139, 123, 104, 255},
        borderFocus = {216, 164, 65, 255},
        disabled = {211, 199, 182, 255},
        disabledText = {155, 142, 126, 255},
        success = {143, 164, 106, 255},
        warning = {229, 178, 69, 255},
        error = {200, 106, 82, 255},
        info = {154, 169, 184, 255},
        overlay = {0, 0, 0, 128},
    },
    radius = {
    ...
    components = {
        Checkbox = {
            ...
            checkedBorderColor = {200, 149, 48, 255},
            checkmarkColor = {90, 74, 55, 255},
        },
        Toggle   = {
            borderRadius = 8, thumbSize = 18,
            thumbColor = {126, 113, 99, 255},
            thumbCheckedColor = {255, 249, 241, 255},
            thumbHoverColor = {79, 67, 52, 255},
            trackBorderColor = {139, 123, 104, 255},
            trackHoverBorderColor = {216, 164, 65, 255},
            trackCheckedBgColor = {216, 164, 65, 255},
            trackCheckedHoverBgColor = {228, 190, 75, 255},
        },
        Slider   = { borderRadius = 8, thumbBorderRadius = 8, borderWidth = 1, thumbBorderWidth = 2, thumbBorderColor = {200, 149, 48, 255} },
        TextField = { borderWidth = 3 },
        Button   = {
            borderWidth = 3, boxShadow = BAZAAR_SHADOW,
            decorations = {
                primary = {
                    { width = "92%", height = 4, backgroundColor = {247, 216, 137, 255},
                      pressedBackgroundColor = {214, 170, 85, 255},
                      borderRadius = 8, position = "absolute", top = 4, alignSelf = "center" },
                    { width = 9, height = 6, backgroundColor = {185, 135, 43, 255},
                      hoverBackgroundColor = {200, 149, 48, 255}, pressedBackgroundColor = {167, 122, 36, 255},
                      borderRadius = 8, position = "absolute", top = 5, right = 5, rotate = 18 },
                },
                secondary = {
                    { width = "92%", height = 4, backgroundColor = {233, 222, 206, 255},
                      pressedBackgroundColor = {205, 191, 170, 255},
                      borderRadius = 8, position = "absolute", top = 4, alignSelf = "center" },
                    { width = 10, height = 6, backgroundColor = {165, 149, 126, 255},
                      hoverBackgroundColor = {165, 149, 126, 255}, pressedBackgroundColor = {146, 130, 109, 255},
                      borderRadius = 8, position = "absolute", bottom = 5, left = 6, rotate = 14 },
                },
                danger = {
                    { width = "92%", height = 4, backgroundColor = {232, 160, 141, 255},
                      pressedBackgroundColor = {230, 127, 114, 255},
                      borderRadius = 8, position = "absolute", top = 4, alignSelf = "center" },
                },
                success = {
                    { width = "92%", height = 4, backgroundColor = {197, 215, 163, 255},
                      pressedBackgroundColor = {158, 196, 138, 255},
                      borderRadius = 8, position = "absolute", top = 4, alignSelf = "center" },
                },
            },
        },
        Card     = { borderWidth = 3, boxShadow = BAZAAR_SHADOW, borderRadius = 12 },
        Modal    = {
            borderWidth = 2, boxShadow = BAZAAR_SHADOW, borderRadius = 14,
            headerBgColor = {185, 173, 154, 255},
            headerBorderWidth = 0,
            contentBgColor = {232, 219, 200, 255},
            footerBorderWidth = 2,
            footerFullWidthBorder = true,
        },
        Drawer   = { borderWidth = 2, boxShadow = BAZAAR_SHADOW },
        Menu     = { variant = "outlined", borderWidth = 3, boxShadow = BAZAAR_SHADOW, itemHoverInset = 0, itemHoverRadius = 0, itemHoverBgColor = {217, 217, 198, 255} },
        Dropdown = { borderWidth = 3, boxShadow = BAZAAR_SHADOW, itemHoverInset = 0, itemHoverRadius = 0, itemHoverBgColor = {217, 217, 198, 255}, itemHoverTextColor = {216, 164, 65, 255} },
        List = { borderWidth = 3, borderRadius = 14, itemHoverBgColor = {217, 217, 198, 255}, itemSelectedBgColor = {217, 217, 198, 255}, itemSelectedTextColor = {216, 164, 65, 255}, itemHoverTextColor = {216, 164, 65, 255} },
        Table = {
            variant = "striped", borderWidth = 3, borderRadius = 14,
            headerBorderWidth = 3, rowBorderWidth = 1,
            headerBgColor = {217, 204, 185, 255},
            rowOddBgColor = {214, 203, 185, 255},
            rowEvenBgColor = {200, 189, 172, 255},
            rowHoverBgColor = {216, 216, 199, 255},
        },
        Toast    = {
            borderWidth = 2, boxShadow = BAZAAR_SHADOW, borderRadius = 10,
            toastBgColor = {228, 213, 190, 255},
            accentBarHeight = 32,
            accentBarInset = 12,
            showIcon = false,
        },
        Tooltip  = {
            borderWidth = 2, boxShadow = BAZAAR_SHADOW, borderRadius = 8,
            tooltipBgColor = {30, 30, 58, 240},
        },
        Popover  = { borderWidth = 2, boxShadow = BAZAAR_SHADOW },
        Alert    = { borderWidth = 2 },
        ProgressBar = { height = 16, borderWidth = 2 },
        Badge    = { borderWidth = 1, borderRadius = 8 },
        Chip     = { borderWidth = 2 },
        Avatar   = { showBorder = true },
        Tabs     = { borderWidth = 2, activeBorderColor = {170, 122, 27, 255}, activeTextColor = {90, 74, 55, 255} },
        Accordion = {
            variant = "default", borderWidth = 3, borderRadius = 14,
            headerExpandedBgColor = {217, 204, 185, 255},
            collapsedTextColor = {126, 113, 99, 255},
            indicatorExpandedColor = {216, 164, 65, 255},
            contentBgColor = {212, 204, 190, 255},
        },
        Stepper  = { borderWidth = 2, hoverBorderColor = {216, 164, 65, 255}, activeTextColor = {90, 74, 55, 255} },
        Pagination = {
            buttonBorderWidth = 3,
            hoverBorderColor = {216, 164, 65, 255},
            activeBgColor = {216, 164, 65, 255},
            activeBorderColor = {168, 115, 30, 255},
            activeTextColor = {90, 74, 55, 255},
        },
    },
})
...
local function initUI()
    UI.Init({
        theme = GoldenBazaarTheme,
        fonts = {
            { family = "sans", weights = {
                normal = "Fonts/FunnelSans-Regular.ttf",
                bold = "Fonts/FunnelSans-Bold.ttf",
            }},
            { family = "display", weights = {
                normal = "Fonts/Bungee-Regular.ttf",
            }},
            { family = "mono", weights = {
...
local function buildBasics()
    ...
    do
        ...
        r:AddChild(UI.Button {
            ...
            borderColor = { 168, 115, 30, 255 },
        })
        r:AddChild(UI.Button {
            text = "Stone Slab",
            backgroundColor = { 184, 170, 149, 255 },
            borderColor = { 143, 129, 109, 255 },
        })
        r:AddChild(UI.Button {
            text = "Clay Red",
            backgroundColor = { 200, 106, 82, 255 },
            borderColor = { 145, 90, 69, 255 },
        })

        page:AddChild(demoCard("Button Styles", "Golden gradient, stone slab, clay red with thick inset borders", { r }))
    end
    ...
    do
        ...
        r:AddChild(UI.Panel {
            width = 100, height = 70,
            backgroundColor = { 248, 242, 232, 255 },
            borderColor = UI.Theme.Color("border"),
        })
        r:AddChild(UI.Panel {
            width = 100, height = 70,
        ...
        page:AddChild(demoCard("Panel", "Golden gradient, parchment, stone shadow, rounded corners", { r }))
    end
    ...
    do
        ...
        r:AddChild(UI.Column {
            ...
            children = {
                ...
                UI.Skeleton { variant = "rectangular", width = 180, height = 40 },
            },
        })
...
local function buildData()
    ...
    do
        page:AddChild(demoCard("Accordion", "Expandable content sections", {
            UI.Accordion {
                items = {
                    { id = "faq1", title = "What is UrhoX?", defaultExpanded = true, content = "UrhoX is a modern game engine based on Urho3D with AI-friendly development tools." },
...
function Start()
    ...
    topBar:AddChild(UI.Label {
        text = "Golden Bazaar Gallery",
        fontSize = 18,
        fontWeight = "bold",
        fontColor = { 255, 244, 212, 255 },
        textShadow = { offsetX = 1, offsetY = 1, blur = 0, color = {110, 93, 70, 150} },
    })
    ...
    footer:AddChild(UI.Label {
        text = "Golden Bazaar v" .. UI.VERSION,
        fontSize = 11,
        fontColor = UI.Theme.Color("textSecondary"),
    })
