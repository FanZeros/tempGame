...
do
    local manager = GetGraphics() ~= nil and _G.fontManager
    if manager and manager.SetGlobalFallbackFonts then
        manager:SetGlobalFallbackFonts({ "Fonts/MiSans-Regular.ttf" })
    end
end
...
require('LuaScripts/Utilities/Previews/RewardVideoAd')
