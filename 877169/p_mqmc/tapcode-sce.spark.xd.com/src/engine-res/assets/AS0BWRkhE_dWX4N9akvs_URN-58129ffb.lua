-- ============================================================================
-- UrhoX UI Gallery — Default Dark Style
-- Elegant showcase of all 42 UI widgets with interactive demos
-- Styled with Default Dark theme: deep navy, steel cyan, bottom-stroke depth
-- ============================================================================
...
local function buildBasics()
    ...
    do
        ...
        page:AddChild(demoCard("Button", "Interactive buttons with variant styles and depth effect", { r }))
    end
    ...
    do
        ...
        page:AddChild(demoCard("Button Styles", "Gradients, shadows, and outlined variant", { r }))
    end
...
local function buildLayout()
    ...
    do
        ...
        local gridColors = {
            ...
            { 79, 136, 193, 255 },   -- primarySoft
            { 69, 100, 127, 255 },   -- secondary
        }
        for i = 1, 6 do
...
function Start()
    ...
    topBar:AddChild(UI.Label {
        text = "v" .. UI.VERSION,
        fontSize = 12,
        fontColor = UI.Theme.Color("textMuted"),
    })
