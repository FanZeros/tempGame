...
#define sEnvSpecular u_EnvSpecular
    ...
    // Sparse4 owns TU_CUSTOM2 (slot 7) for its Directory. Keep every other
    // slot-7 declaration out of that compile-time variation.
    #ifndef VOXEL_SPARSE4
        SAMPLER2DARRAY(u_TerrainData, 7);
        SAMPLER2DARRAY(u_PaintMap, 7);
